...
public class UserResource {
     ...
     * logger.info("[RRM] user.debitCardValidationCode: " +
     * user.debitCardValidationCode);
     * logger.info("[RRM] user.identificationDocumentNumber: " +
     * user.identificationDocumentNumber);
     * logger.info("[RRM] user.identificationDocumentType: " +
